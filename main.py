...
openai.api_key = "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"
...
question_2 = st.multiselect("What are your salary expectations?",["Less than $40K", "$40K - $70K", "$70K - $100K", "Above $100K"])
question_3 = st.multiselect("What standard school subject or subjects do you enjoy the most?", ["Math", "Arts", "Biology", "Chemistry", "Physics", "Technology", "Business", "Social Studies","Physical Education", "Other"])
...
question_6 = st.multiselect("What work environment do you prefer?", ["Office", "Outdoors", "Lab", "Remote", "Fieldwork"])
...
question_12 = st.multiselect("What industries would you like to work in?", ["Healthcare","Education", "Agriculture", "Construction", "Transportation", "Energy", "Entertainment", "Art", "Hospitality", "Software", "Hardware", "Finance", "Manufacturing", "Culinary", "Engineering", "Marketing", "Advising", "Research", "Sales", "Investing", "Law", "Business", "Aerospace", "Manual Labor"])
question_13 = st.multiselect("How much education are you willing to go through?", ["Bachelor's degree", "Master's degree", "Community college", "No college"])
question_14 = st.text_area("What are you passionate about?")
